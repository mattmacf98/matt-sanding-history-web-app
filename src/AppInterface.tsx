                                                  ...
                                                  {expandedFiles.has(passId) && passFiles.length > 0 && (
                                                    <>
                                                      ...
                                                      <div style={{
                                                        ...
                                                        {passFiles
                                                          .filter(file => {
                                                            const searchTerm = (fileSearchInputs[passId] || '').toLowerCase();
                                                            if (!searchTerm) return true;
                                                            const fileName = file.metadata?.fileName?.split('/').pop() || '';
                                                            const fullPath = file.metadata?.fileName || '';
                                                        ...
                                                        {passFiles.filter(file => {
                                                          ...
                                                          return !(fileName.toLowerCase().includes(searchTerm) || 
                                                                   fullPath.toLowerCase().includes(searchTerm));
                                                        }).length === passFiles.length && fileSearchInputs[passId] && (
                                                          <div style={{
                                                            padding: '12px',
                                                            color: '#6b7280',
                                                            fontSize: '13px'
