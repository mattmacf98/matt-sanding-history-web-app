                                ...
                                <div className="flex gap-8">
                                  ...
                                  <div className="info-section">
                                    ...
                                    pass.build_info.date_compiled ? (
                                      ...
                                      <div className="info-notice">
                                        Build information not available for this
                                        run.
                                      </div>
                                    )}
                                  </div>
                                  <div className="info-section">
                                    ...
                                    >
                                      ...
                                      {(() => {
                                        const flatPasses =
                                          Object.values(groupedPasses).flat()
                                        const { prevPass, configChanged } =
                                          getPassConfigComparison(
                                            pass,
                                            flatPasses,
                                            configMetadata
                                    ...
                                    {loadingConfigMetadata.has(pass.pass_id) ? (
                                      ...
                                      >
                                        {(() => {
                                          const metadata = configMetadata.get(
                                            pass.pass_id
                                          )!
                                          return (
                                            <>
