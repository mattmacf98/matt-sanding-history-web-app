...
export const ResourceSelection = (props: ResourceSelectionProps) => {
    ...
    return (
        <div className='flex gap-8'>
            ...
            <VideoStoreSelector onVideoStoreSelected={props.setVideoStoreClient} />
            ...
            {!robotClient ? (
            ...
            ) : props.cameraComponentNames.length > 0 ? (
                <select
                id="camera-select"
                value={props.selectedCamera}
                onChange={(e) => {
                    props.setSelectedCamera(e.target.value);
                ...
                {props.cameraComponentNames.map(name => (
